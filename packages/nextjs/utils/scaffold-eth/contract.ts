...
// Skip the expensive MergeDeep entirely while no external contracts exist —
// large local ABIs otherwise exceed TS instantiation limits.
const contractsData =
  Object.keys(externalContractsData).length > 0
